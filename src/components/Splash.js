...
const Splash = forwardRef(({header, description}, ref) => {
  return (
    <header  ref={ref} id='splash'  className='w-full flex justify-center items-center h-[100vh] bg-customGreen py-3 lg:py-0'>
